...
std::vector<GroupConvModelTestParams> all_tests{{models[0], Gna2DeviceVersion3_5, false},
                                                {models[1], Gna2DeviceVersion3_5, false},
                                                {models[0], Gna2DeviceVersionEmbedded3_6, true},
                                                {models[1], Gna2DeviceVersionEmbedded3_6, true}};
...
protected:
    ...
    void SetUp() override {
        ...
        auto parameter = std::make_shared<ngraph::opset11::Parameter>(f32, ngraph::Shape{model.input_size});

        auto conv = std::dynamic_pointer_cast<ngraph::opset11::GroupConvolution>(
            ngraph::builder::makeGroupConvolution(parameter,
                                                  ...
                                                  c_num_out_channels,
                                                  model.num_groups));
        auto result = std::make_shared<ngraph::opset11::Result>(conv);
