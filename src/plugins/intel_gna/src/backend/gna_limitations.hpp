...
public:
     ...
     */
    //bool is_pooling_supported(const std::shared_ptr<ov::intel_gna::op::GNAPool> max_pool,
    bool is_pooling_supported(const std::shared_ptr<ov::Node> node, bool is_exception_allowed = false);
